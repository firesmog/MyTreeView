package com.readboy.mytreeview.utils.log;
...
public class LogUtils {
    ...
    private static String MYLOG_PATH_SDCARD_DIR = "/sdcard/mywebview/log";// 日志文件在sdcard中的路径
    ...
    private static void getMethodNames(StackTraceElement[] sElements){
        tag = Constants.TAG_HEAD + sElements[1].getFileName();
